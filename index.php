...
<html lang="en" dir="ltr" id="html">
  <head>
    ...
    <title>SISTEM PENGUKURAN KEMIRIPAN DOKUMEN TEXT BAHASA INDONESIA BERBASIS TEMU KEMBALI INFORMASI</title>
        ...
        <div class="container text-center">
          ...
          <div class="collapse navbar-collapse" id="isinav">
            <ul class="nav nav-justified">
              ...
              <li><a href="?page=stemming"><i class="fa fa-file-code-o fa-2x"></i>Stemming Dokumen</a></li>
              <li><a href="?page=kamus"><i class="fa fa-book fa-2x"></i>Kamus Data</a></li>
            </ul>
          </div>
        </div>
      </div>
