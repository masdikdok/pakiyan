<div class="row">
  <div class="col-xs-12">
    <p>Contoh proses stemming pada section ini menggunakan <b>Algoritma ECS</b></p>
  </div>
</div>

<div class="panel panel-default">
  <div class="panel-heading">
    <b>Formulir Stemming Menggunakan Algoritma ECS</b>
  </div>
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <?php
          echo $IrController->stemming($kata, 'ECS');
          ?>
        </div>
      </div>
    </div>
